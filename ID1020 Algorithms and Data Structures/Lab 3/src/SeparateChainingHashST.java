...
public class SeparateChainingHashST<Key extends Comparable<Key>, Value> {
    ...
    private BinarySearchST<Key, Value>[] st;  // array of linked-list symbol tables
    ...
    public SeparateChainingHashST(int m) {
        this.m = m;
        st = (BinarySearchST<Key, Value>[]) new BinarySearchST[m];
        for (int i = 0; i < m; i++)
            st[i] = new BinarySearchST<Key, Value>();
    }
